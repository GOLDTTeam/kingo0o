...
LuaTele = luatele.set_config{api_id=14471516,api_hash='94a6d01e235a29c5f8032f942011095d',session_name=MEZO,token=Token}
...
elseif UserId == MEZO then Status = true
...
if Redis:sismember(MEZO.."BanGroup:Group"..chat,useri) then
BanGroupz = "✓"
else
BanGroupz = "✗"
end
if Redis:sismember(MEZO.."SilentGroup:Group"..chat,useri) then
SilentGroupz = "✓"
else
SilentGroupz = "✗"
end
if Redis:sismember(MEZO.."Supcreator:Group"..chat,useri)  then
TheBasicsz = "✓"
else
TheBasicsz = "✗"
end
if Redis:sismember(MEZO.."Creator:Group"..chat,useri) then
Originatorsz = "✓"
else
Originatorsz = "✗"
end
if Redis:sismember(MEZO.."Manger:Group"..chat,useri) then
Managersz = "✓"
else
Managersz = "✗"
end
if Redis:sismember(MEZO.."Admin:Group"..chat,useri) then
Addictivez = "✓"
else
Addictivez = "✗"
end
if Redis:sismember(MEZO.."Special:Group"..chat,useri) then
Distinguishedz = "✓"
else
Distinguishedz = "✗"
end
...
local N = (Redis:get(MEZO.."Name:Bot") or "جولد")
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكوم اكثر من :'..Redis:get(MEZO..'Num:Add:Bot'),"md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
...
Get_Is_Id = Redis:get(MEZO.."Set:Id:Group"..msg_chat_id) or Redis:get(MEZO.."Set:Id:Groups")
...
local vip = Redis:smembers(MEZO.."Special:Group"..msg_chat_id) 
local admin = Redis:smembers(MEZO.."Admin:Group"..msg_chat_id) 
local manger = Redis:smembers(MEZO.."Manger:Group"..msg_chat_id) 
local creator = Redis:smembers(MEZO.."Creator:Group"..msg_chat_id) 
local basiccreator = Redis:smembers(MEZO.."Supcreator:Group"..msg_chat_id) 
local owner = Redis:smembers(MEZO.."Owners:Group"..msg_chat_id) 
local dev = Redis:smembers(MEZO.."Dev:Groups") 
local devss = Redis:smembers(MEZO.."Devss:Groups") 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',data = {
...
TheBasics = Redis:sismember(MEZO.."Supcreator:Group"..msg.chat_id,UserId_Info.id) 
Originators = Redis:sismember(MEZO.."Creator:Group"..msg.chat_id,UserId_Info.id)
Managers = Redis:sismember(MEZO.."Manger:Group"..msg.chat_id,UserId_Info.id)
Addictive = Redis:sismember(MEZO.."Admin:Group"..msg.chat_id,UserId_Info.id)
Distinguished = Redis:sismember(MEZO.."Special:Group"..msg.chat_id,UserId_Info.id)
BanGroup = Redis:sismember(MEZO.."BanGroup:Group"..msg.chat_id,UserId_Info.id)
SilentGroup = Redis:sismember(MEZO.."SilentGroup:Group"..msg.chat_id,UserId_Info.id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
TheBasics = Redis:sismember(MEZO.."Supcreator:Group"..msg.chat_id,Message_Reply.sender.user_id) 
Originators = Redis:sismember(MEZO.."Creator:Group"..msg.chat_id,Message_Reply.sender.user_id)
Managers = Redis:sismember(MEZO.."Manger:Group"..msg.chat_id,Message_Reply.sender.user_id)
Addictive = Redis:sismember(MEZO.."Admin:Group"..msg.chat_id,Message_Reply.sender.user_id)
Distinguished = Redis:sismember(MEZO.."Special:Group"..msg.chat_id,Message_Reply.sender.user_id)
BanGroup = Redis:sismember(MEZO.."BanGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
SilentGroup = Redis:sismember(MEZO.."SilentGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
if Jabwa.first_name then
MEZOusername = '*طلب ↫ *['..bain.first_name..'](tg://user?id='..bain.id..')*\nالزواج من ↫ *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')*\nهل العروسه مواقفه علي هذا\n*'
else
MEZOusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
return LuaTele.sendText(msg_chat_id,msg_id,MEZOusername,"md",false, false, false, false, reply_markup)
end
...
LuaTele.sendText(msg_chat_id,msg_id,Redis:get(MEZO.."chadmin"..msg_chat_id),"md",true)  
else 
...
if Redis:smembers(MEZO.."Supcreator:Group"..msg_chat_id) then
Redis:del(MEZO.."Supcreator:Group"..msg_chat_id) 
end
if Redis:smembers(MEZO.."Creator:Group"..msg_chat_id) then
Redis:del(MEZO.."Creator:Group"..msg_chat_id) 
end
if Redis:smembers(MEZO.."Manger:Group"..msg_chat_id) then
Redis:del(MEZO.."Manger:Group"..msg_chat_id) 
end
if Redis:smembers(MEZO.."Admin:Group"..msg_chat_id) then
Redis:del(MEZO.."Admin:Group"..msg_chat_id) 
end
if Redis:smembers(MEZO.."Special:Group"..msg_chat_id) then
...
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد رسائلك هنا*~ '..(Redis:get(MEZO..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'تعديلاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد التعديلات هنا*~ '..(Redis:get(MEZO..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/MEZOb0t'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
text = text:gsub('`','') 
text = text:gsub('*','') 
Redis:sadd(MEZO.."Add:Rd:array:Text"..test..msg_chat_id,text)  
_key = {
...
if not Redis:sismember(MEZO.."Add:Rd:array:Text"..gery..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  لا يوجد رد متعدد* ',"md",true)
return false
end
Redis:srem(MEZO.."Add:Rd:array:Text"..gery..msg_chat_id,text)
...
Redis:del(MEZO.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(MEZO..'List:array'..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  لا يوجد رد متعدد* ',"md",true)
return false
end
...
Redis:sadd(MEZO.."List:array"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:del(MEZO.."Add:Rd:array:Text"..text..msg_chat_id)
Redis:srem(MEZO..'List:array'..msg_chat_id, text)
...
if text then
if  Redis:sismember(MEZO..'List:array'..msg_chat_id,text) then
local list = Redis:smembers(MEZO.."Add:Rd:array:Text"..text..msg_chat_id)
...
local list = Redis:smembers(MEZO..'List:array'..msg_chat_id..'')
...
local TextingDevMEZO = Redis:get(MEZO..'Texting:DevMEZO')
...
---زخرفة ----
if Redis:get(MEZO.."toen"..msg.sender.user_id) == "on" then
...
if Redis:get(MEZO.."toar"..msg.sender.user_id) == "on" then
...
if text and Redis:get(MEZO..msg.chat_id.."name_mean"..msg.sender.user_id) == "true" then 
Redis:del(MEZO..msg.chat_id.."name_mean"..msg.sender.user_id)
...
Redis:set(MEZO..msg.chat_id.."name_mean"..msg.sender.user_id , true)
...
keyboard.inline_keyboard = {
{
{text = '𝐃𝐞𝐯: 𝐒𝐨𝐮𝐫𝐜𝐞', url = "https://t.me/DV_MEZO"},{text = '𝐂𝐡: 𝐒𝐨𝐮𝐫𝐜𝐞', url = "https://t.me/AKJA0"},
},
{
{text = '𝐄𝐱𝐩 𝐒𝐨𝐮𝐫𝐜𝐞', url = "http://t.me/exp_MEZO"}
},
}
...
if text == (Redis:get(MEZO.."Name:Bot") or "جولد") then
local NamesBot = (Redis:get(MEZO.."Name:Bot") or "جولد")
local NameBots = {
"قلب "..NamesBot ,
"معاك",
"نعم ؟",
...
local CmdStart = '\n⋄︙مرحبا انا بوت '..(Redis:get(MEZO.."Name:Bot") or "جولد")..
...
reply_markup = {
inline_keyboard ={
{{text ="• MEZO Source", url= "https://t.me/AKJA0"}},
}
},
},
}
...
data.The_Controller = 1
elseif Redis:sismember(MEZO.."Devss:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(MEZO.."Dev:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(MEZO.."Owners:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(MEZO.."Supcreator:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(MEZO.."Creator:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(MEZO.."Manger:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(MEZO.."Admin:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(MEZO.."Special:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(MEZO) then
...
if Redis:sismember(MEZO.."Supcreator:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."Supcreator:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."Supcreator:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(MEZO.."Creator:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."Creator:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."Creator:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(MEZO.."Manger:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."Manger:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."Manger:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(MEZO.."Admin:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."Admin:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."Admin:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(MEZO.."Special:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."Special:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."Special:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(MEZO.."Creator:Group"..ChatId,UserId[2])
Redis:srem(MEZO.."Special:Group"..ChatId,UserId[2])
Redis:srem(MEZO.."SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(MEZO.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(MEZO.."BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(MEZO.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(MEZO.."SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local Info_Members = Redis:smembers(MEZO.."Owners:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MEZO.."Supcreator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MEZO.."Creator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MEZO.."Manger:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MEZO.."Admin:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MEZO.."Special:Group"..ChatId) 
if #Info_Members == 0 then
...
local UserId = {Text:match('(%d+)/statusTheBasicsz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(MEZO.."MEZO:TheBasics:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."MEZO:TheBasics:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."MEZO:TheBasics:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusOriginatorsz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(MEZO.."MEZO:Originators:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."MEZO:Originators:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."MEZO:Originators:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusManagersz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(MEZO.."MEZO:Managers:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."MEZO:Managers:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."MEZO:Managers:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusAddictivez/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(MEZO.."MEZO:Addictive:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."MEZO:Addictive:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."MEZO:Addictive:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
local UserId = {Text:match('(%d+)/statusDistinguishedz/(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(MEZO.."MEZO:Distinguished:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."MEZO:Distinguished:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."MEZO:Distinguished:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(MEZO.."MEZO:Originators:Group"..ChatId,UserId[2])
Redis:srem(MEZO.."MEZO:TheBasics:Group"..ChatId,UserId[2])
Redis:srem(MEZO.."MEZO:SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(MEZO.."MEZO:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if Redis:sismember(MEZO.."MEZO:BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."MEZO:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(MEZO.."MEZO:BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'banned',0)
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
...
if Redis:sismember(MEZO.."MEZO:SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(MEZO.."MEZO:SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(MEZO.."MEZO:SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:set(MEZO.."Set:Manager:rd"..IdUser..":"..ChatId,"true")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ MEZO',url='http://t.me/AKJA0'}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'sᴏᴜʀᴄʀ MEZO',url='http://t.me/AKJA0'}},}
...
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'تعط','تعطيل الايدي بالصوره')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"تعط")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'تفع','تفعيل الايدي بالصوره')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"تفع")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'ا','ايدي')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"ا")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'م','رفع مميز')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"م")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'اد', 'رفع ادمن')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"اد")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'مد','رفع مدير')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"مد")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'من', 'رفع منشئ')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"من")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'اس', 'رفع منشئ اساسي')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"اس")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'مط','رفع مطور')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"مط")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'ثانوي','رفع مطور ثانوي')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"ثانوي")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'تك','تنزيل الكل')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"تك")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'ر','الرابط')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"ر")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'رر','ردود المدير')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"رر")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'مسح المكتومين','ممكتومين')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"ممكتومين")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'رد','اضف رد')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"رد")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'سح','مسح سحكاتي')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"سح")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'رس','مسح رسائلي')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"رس")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'غ','غنيلي')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"غ")
Redis:set(MEZO.."Get:Reides:Commands:Group"..ChatId..":"..'#','مسح قائمه العام')
Redis:sadd(MEZO.."Command:List:Group"..ChatId,"#")
local txxt = [[
⋆ تم ترتيب الاوامر بالشكل التالي ~
⋆  ايدي - ا .
⋆  رفع مميز - م .
...
MEZOusername = '*تم الزواج بنجاح \nمبروك  يا  ↫ *['..bain.first_name..'](tg://user?id='..bain.id..' *\n*'
else
MEZOusername = 'لا يوجد'
end
LuaTele.editMessageText(ChatId,Msg_id,MEZOusername, 'md', true, false, reply_markup)
end
end
